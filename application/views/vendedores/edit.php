                ...
                <form class="user" method="POST" name="form_edit">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-2">
                                <label>Codigo</label>
                                <input type="text" class="form-control form-control-user cod" name="vendedor_codigo" placeholder="Codigo do vendedor" value="<?php echo $vendedor->vendedor_codigo; ?>">
                                <?php echo form_error('vendedor_codigo','<small class="form-text text-danger">','</small>'); ?>
                            </div>
                            <div class="col-md-2">
                                <label>NUIT</label>
                                <input type="text" class="form-control form-control-user cnpj" name="vendedor_cpf" placeholder="NUIT do vendedor" value="<?php echo $vendedor->vendedor_cpf; ?>">
                                <?php echo form_error('vendedor_cpf','<small class="form-text text-danger">','</small>'); ?>
                            </div>
                            <div class="col-md-4">
                                <label>Bilhete de Identidade (BI)</label>
                                <input type="text" class="form-control form-control-user _rg_ie" name="vendedor_rg" placeholder="(BI) do vendedor" value="<?php echo $vendedor->vendedor_rg; ?>">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-user phone_with_ddd" name="vendedor_celular" placeholder="Nº Alternativo" value="<?php echo $vendedor->vendedor_celular ; ?>">
                                <?php echo form_error('vendedor_celular','<small class="form-text text-danger">','</small>'); ?>
                            </div>
                            <div class="col-md-4">
                                 <label>Nº de Alternativo </label>
                                 <input type="text" class="form-control form-control-user phone_with_ddd" name="vendedor_telefone" placeholder="telefone do vendedor" value="<?php echo $vendedor->vendedor_telefone ; ?>">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control form-control-user en" name="vendedor_numero_endereco" value="<?php echo $vendedor->vendedor_numero_endereco ; ?>">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control form-control-user cep" name="vendedor_cep" placeholder="Código Postal do vendedor" value="<?php echo $vendedor->vendedor_cep ; ?>">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea type="text" class="form-control form-control-user" name="vendedor_obs" value="<?php echo $vendedor->vendedor_obs ; ?>"></textarea>
