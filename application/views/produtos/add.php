                ...
                <form class="user" method="POST" name="form_add">
                        ...
                        <div class="form-group row mb-3">
                            <div class="col-md-3">
                                ...
                                <select class="custom-select" name="produto_marca_id">
                                    ...
                                    <option title="<?php echo ($marca->marca_ativa==0 ? 'Não pode ser escolhido':'Marca Ativa');?>" value="<?php echo $marca->marca_id;?>" <?php echo ($marca->marca_ativa==0 ? 'disabled' : ''); ?>><?php echo ($marca->marca_ativa == 0 ? $marca->marca_nome . '&nbsp;->&nbsp;Inativa': $marca->marca_nome ) ?></option>
                                    <?php endforeach; ?>
                                </select> 
                            </div>
                            <div class="col-md-3">
                                ...
                                <select class="custom-select" name="produto_categoria_id">
                                    <?php foreach ($categorias as $categoria): ?>
                                        <option title="<?php echo ($categoria->categoria_ativa==0 ? 'Não pode ser escolhido':'Categoria Ativa');?>" value="<?php echo $categoria->categoria_id;?>" <?php echo ($categoria->categoria_ativa==0 ? 'disabled' : ''); ?>><?php echo ($categoria->categoria_ativa == 0 ? $categoria->categoria_nome . '&nbsp;->&nbsp;Inativa': $categoria->categoria_nome ) ?></option>
                            ...
                            <select class="custom-select" name="produto_fornecedor_id">
                                <?php foreach ($fornecedores as $fornecedor): ?>
                                    <option title="<?php echo ($fornecedor->fornecedor_ativo == 0 ? 'Não pode ser escolhido' : 'Fornecedor Ativo');?>" value="<?php echo $fornecedor->fornecedor_id;?>"<?php echo ($fornecedor->fornecedor_ativo == 0 ? 'disabled' : ''); ?>><?php echo ($fornecedor->fornecedor_ativo == 0 ? $fornecedor->fornecedor_nome_fantasia . '&nbsp;->&nbsp;Inativa' : $fornecedor->fornecedor_nome_fantasia); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                            <div class="col-md-3">
                            <label>Produto Unidade</label>
                                <input type="text" class="form-control form-control-user" name="produto_unidade" placeholder="Unidade de Produto" value="<?php echo set_value('produto_unidade'); ?>">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control form-control-user" name="produto_estoque_minimo" placeholder="estoque minimo" value="<?php echo set_value('produto_estoque_minimo'); ?>">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-md-9 md-3">
                                ...
                                <textarea type="text" class="form-control form-control-user" name="produto_obs" value="<?php echo set_value('produto_obs') ; ?>"></textarea>
