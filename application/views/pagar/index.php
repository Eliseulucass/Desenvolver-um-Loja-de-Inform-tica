                        ...
                        <tbody>
                            <?php foreach ($contas_pagar as $conta): ?>
                                <tr>
                                    ...
                                    <td><?php echo 'MT&nbsp;' . $conta->conta_pagar_valor ?></td>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a title="Excluir" href="javascript:void(0)" data-toggle="modal" data-target="#contas_pagar-<?php echo $conta->conta_pagar_id; ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>

                                <div class="modal fade" id="contas_pagar-<?php echo $conta->conta_pagar_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
