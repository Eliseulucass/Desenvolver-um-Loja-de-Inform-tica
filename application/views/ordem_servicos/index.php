                        ...
                        <tbody>
                            <?php foreach ($ordens_servicos as $os): ?>
                                <tr>
                                    ...
                                    <td><?php echo 'MT&nbsp;' . $os->ordem_servico_valor_total ?></td>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a title="Excluir" href="javascript(void)" data-toggle="modal" data-target="#os-<?php echo $os->ordem_servico_id; ?>" class="btn btn-sm btn-danger"><i class="far fa-trash-alt"></i></a>
                                    </td>
                                </tr>
