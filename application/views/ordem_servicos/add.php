                                ...
                                <div class="col-sm-6 mb-1 mb-sm-0">
                                    ...
                                    <select class="custom-select contas_receber" name="ordem_servico_cliente_id" required="">
                                        ...
                                        <?php foreach ($clientes as $cliente): ?>
                                            <option value="<?php echo $cliente->cliente_id; ?>"><?php echo $cliente->cliente_nome . ' ' . $cliente->cliente_sobrenome . ' | NUIT ou Alvará Comercial: ' . $cliente->cliente_cpf_cnpj; ?></option>
                                        <?php endforeach; ?>
                                    </select>
