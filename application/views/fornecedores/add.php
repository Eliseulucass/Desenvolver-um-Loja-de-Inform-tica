...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form class="user" method="POST" name="form_">
                   ...
                   <?php endif; ?>
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row mb-3">
                            <div class="col-md-6">
                                <label>Nome</label>
                                <input type="text" class="form-control form-control-user" name="fornecedor_nome_fantasia" placeholder="nome do fornecedor" value="<?php echo set_value('fornecedor_nome_fantasia'); ?>">
                                <?php echo form_error('fornecedor_nome_fantasia','<small class="form-text text-danger">','</small>'); ?>
                            </div>
                            <div class="col-md-6">
                                <label>Tipo de Serviços</label>
                                <input type="text" class="form-control form-control-user" name="fornecedor_razao" placeholder="Tipo d fornecedor" value="<?php echo set_value('fornecedor_razao'); ?>">
                        ...
                        <div class="form-group row mb-3">
                            <div class="col-md-4">
                                <label>NUIT</label>
                                <input type="text" class="form-control form-control-user cnpj" name="fornecedor_cnpj" placeholder="Tipo d fornecedor" value="<?php echo set_value('fornecedor_cnpj'); ?>">
                                <?php echo form_error('fornecedor_cnpj','<small class="form-text text-danger">','</small>'); ?>
                            </div>
                            <div class="col-md-4">
                                <label>Alvará Comercial</label>
                                <input type="text" class="form-control form-control-user ie" name="fornecedor_ie" placeholder="Alvará Comercial" value="<?php echo set_value('fornecedor_ie'); ?>">
                                <?php echo form_error('fornecedor_ie','<small class="form-text text-danger">','</small>'); ?>
                            </div>
                            <div class="col-md-4">
                                 <label>Nº de Telefone</label>
                                 <input type="text" class="form-control form-control-user phone_with_ddd" name="fornecedor_telefone" placeholder="telefone do fornecedor" value="<?php echo set_value('fornecedor_telefone'); ?>">
                        ...
                        <div class="form-group row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-user phone_with_ddd" name="fornecedor_celular" placeholder="Nº Alternativo" value="<?php echo set_value('fornecedor_celular') ; ?>">
                                <?php echo form_error('fornecedor_celular','<small class="form-text text-danger">','</small>'); ?>
                            </div>
                            <div class="col-md-4">
                                 <label>E-Mail</label>
                                 <input type="email" class="form-control form-control-user" name="fornecedor_email" placeholder="e-mail do fornecedor" value="<?php echo set_value('fornecedor_email') ; ?>">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control form-control-user en" name="fornecedor_numero_endereco" value="<?php echo set_value('fornecedor_numero_endereco') ; ?>">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control form-control-user cep" name="fornecedor_cep" placeholder="Código Postal do fornecedor" value="<?php echo set_value('fornecedor_cep') ; ?>">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea type="text" class="form-control form-control-user" name="fornecedor_obs" value="<?php echo set_value('fornecedor_obs') ; ?>"></textarea>
