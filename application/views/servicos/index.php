        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
               <?php if ($this->ion_auth->is_admin()): ?> 
                <a title="Cadastrar novo servico" href="<?php echo base_url('servicos/add'); ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-plus"></i>&nbsp;Novo</a>
                <?php endif; ?>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($servicos as $servico): ?>
                                <tr>
                                    ...
                                    <td><?php echo 'MT&nbsp;'.$servico->servico_preco; ?></td>
                                    ...
                                    <?php if ($this->ion_auth->is_admin()): ?> 
                                    <td class="text-right">
                                        <a title="Editar" href="<?php echo base_url('servicos/edit/' . $servico->servico_id); ?>" class="btn btn-sm btn-primary"><i class="fas fa-pencil-alt"></i></a>
                                ...
                                <!-- Modal para confirmar exclusão do serviço -->
