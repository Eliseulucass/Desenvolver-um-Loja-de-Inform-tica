        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form class="user" method="POST" name="form_edit">
                    <p><strong><i class="fas fa-clock"></i>&nbsp;&nbsp;última alteração:&nbsp;<?php echo formata_data_banco_com_hora($conta_receber->conta_receber_data_alteracao) ?>;</strong></p>
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row mb-3">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="custom-select contas_receber" name="conta_receber_cliente_id">
                                    <?php foreach ($clientes as $cliente): ?>
                                        <option title="<?php echo ($cliente->cliente_ativo == 0 ? 'Não pode ser escolhido' : 'Clienre Ativo');?>" value="<?php echo $cliente->cliente_id;?>" <?php echo ($cliente->cliente_id == $conta_receber->conta_receber_cliente_id) ? 'selected' : ''; ?> <?php echo ($cliente->cliente_ativo == 0 ? 'disabled' : ''); ?>><?php echo ($cliente->cliente_ativo == 0 ? $cliente->cliente_nome . '&nbsp;->&nbsp;Inativa' : $cliente->cliente_nome); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="date" class="form-control form-control-user-date" name="conta_receber_data_vencto" value="<?php echo $conta_receber->conta_receber_data_vencto; ?>">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row">
                            <div class="col-md-9 md-3">
                                ...
                                <textarea class="form-control form-control-user" name="conta_receber_obs"><?php echo $conta_receber->conta_receber_obs ; ?></textarea>
                        ...
                        <button type="submit" class="btn btn-primary btn-sm" <?php echo ($conta_receber->conta_receber_status == 1 ? 'disabled' : ''); ?>>
                            <?php echo ($conta_receber->conta_receber_status == 1 ? 'Conta a Receber' : 'Salvar'); ?>
                        </button>
