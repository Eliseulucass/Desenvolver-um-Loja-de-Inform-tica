...
//        exit();
    ...
    public function add() {
        ...
        if ($this->form_validation->run()) {
            ...
            $venda_valor_total = str_replace('MT', "", trim($this->input->post('venda_valor_total')));
            ...
            $produto_preco_venda = str_replace('MT', '', $this->input->post('produto_preco_venda'));
            $produto_item_total = str_replace('MT', '', $this->input->post('produto_item_total'));
...
//            exit();
            ...
            foreach ($produtos_venda as $produto):
                ...
                $html .= '<td>' . 'MT&nbsp;' . $produto->venda_produto_valor_unitario . '</td>';
                $html .= '<td>' . '%&nbsp;' . $produto->venda_produto_desconto . '</td>';
                $html .= '<td>' . 'MT&nbsp;' . $produto->venda_produto_valor_total . '</td>';
                $html .= '</tr>';
            ...
            $html .= '<td style="border-top: solid #ddd 1px">' . 'MT&nbsp;' . $valor_final_venda->venda_valor_total . '</td>';
